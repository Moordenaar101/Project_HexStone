...
//   // The leg can reach if the distance is less than or equal to the sum of
//   the
//   // segments
...
//                          goal.distanceTo(legOrigin)); // Shift goal towards
//                          the
//   }
...
//                         effectiveGoalZ
//                 );
//                 const hipToGoalDistance =
//                 effectiveGoal.distanceTo(hipPosition);
...
//                 const h = Math.sqrt(adjustedXDistance ** 2 +
//                 adjustedZDistance
// ** 2); const hipToGoal = Math.sqrt(h ** 2 + adjustedRise ** 2);

//                 const joint1 = Math.atan2(adjustedZDistance,
//                 adjustedXDistance);
// // Pivot joint angle const angleA = Math.atan(adjustedRise / h); const angleB
// = Math.acos( (hipToGoal ** 2 + femurLen ** 2 - tibiaLen ** 2) / (2 *
// hipToGoal * femurLen)
//                 );
...
// //   // This function sets the servo positions based on the calculated
// angles.
